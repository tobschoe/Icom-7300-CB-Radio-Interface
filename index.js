...
function fm () {
  port.write(Buffer.from(icomCmd.sendPre + "060502" + icomCmd.sendPost, 'hex'), function (err, result) {
    if (err) {
...
function am () {
  port.write(Buffer.from(icomCmd.sendPre + "0602" + icomCmd.sendPost, 'hex'), function (err, result) {
    if (err) {
      console.log('Error while sending message : ' + err)
    }
  })
...
function usb () {
  port.write(Buffer.from(icomCmd.sendPre + "0601" + icomCmd.sendPost, 'hex'), function (err, result) {
    if (err) {
      console.log('Error while sending message : ' + err)
    }
  })
...
function lsb () {
  port.write(Buffer.from(icomCmd.sendPre + "0600" + icomCmd.sendPost, 'hex'), function (err, result) {
    if (err) {
      console.log('Error while sending message : ' + err)
    }
  })
